...
function expandVoicePanel() {
    // if (elements.inputContainer) {
    //     elements.inputContainer.classList.add('expanded');
    // }
}

function collapseVoicePanel() {
    // if (elements.inputContainer) {
    //     elements.inputContainer.classList.remove('expanded');
    // }
}

function updateVoicePanelText(text, isPlaceholder = false) {
    // if (elements.voiceTextDisplay) {
    //     elements.voiceTextDisplay.textContent = text;
    //     elements.voiceTextDisplay.classList.toggle('placeholder', isPlaceholder);
    // }
    
    // Fallback to updating input value directly if not using panel
    if (elements.messageInput && !isPlaceholder) {
        elements.messageInput.value = text;
    } else if (isPlaceholder) {
        // Optional: Update placeholder if needed
    }
}
...
function updateUILanguage() {
    ...
    //    updateSpeechOverlay(getListeningPromptText());
    // }
    // if (state.isListening && elements.inputContainer && elements.inputContainer.classList.contains('expanded')) {
    //     const isPlaceholder = !state.hasRecognizedText;
    //     updateVoicePanelText(state.hasRecognizedText ? state.finalTranscript : getListeningPromptText(), isPlaceholder);
    // }
